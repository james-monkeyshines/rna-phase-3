#ifndef HETEROGENEOUSMOLCLKMCMCTREE_H
#define HETEROGENEOUSMOLCLKMCMCTREE_H
...
class HeterogeneousMolClkMCMCTree : public MolClkMCMCTree {
private:
    /** ************************************************************************
     * HeterogeneousMolClkMCMCTree
     * @semantics  constructor of the class for the prototype, called once,
     *             with the name used to register to the unique (Singleton)
     *             Factory< MCMCTree >
     ************************************************************************ */
    HeterogeneousMolClkMCMCTree( const string & registrationName );
...
public:
     ...
     ************************************************************************ */
    HeterogeneousMolClkMCMCTree( ParametersSet& parameters );
     ...
     ************************************************************************ */
    virtual ~HeterogeneousMolClkMCMCTree();
...
private:
    static HeterogeneousMolClkMCMCTree prototype;
...
#endif  //HETEROGENEOUSMOLCLKMCMCTREE_H
